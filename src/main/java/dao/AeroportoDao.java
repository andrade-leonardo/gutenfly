...
public class AeroportoDao extends DaoMestre {
    ...
    public static List<Aeroporto> pegarTodosAeroportos(String nome, String cep, String situacao, JComboBox jcbAero) {
    ...
    public static boolean atualizarAeroporto(Aeroporto novoAeroporto, int id) {
     ...
     public static void validaBuscaAeroporto(JComboBox JComboAeroporto, JTextField idAeroporto) {
        for (Aeroporto aero : AeroportoDao.getInstance().pegarTodosAeroportos("", "", "", new JComboBox())) {
            if (JComboAeroporto.getSelectedItem().equals(aero.getNome())) {
                idAeroporto.setText(String.valueOf(aero.getId()));
            }
        }
    }
    ...
    public static void popularTabela(JTable tabela, String nome, String estado, String situacao) {
        ...
        dadosTabela = new Object[pegarTodosAeroportos(nome, estado, situacao, new JComboBox()).size()][7];

        int lin = 0;

        try {
            for (Aeroporto a : pegarTodosAeroportos(nome, estado, situacao, new JComboBox())) {
