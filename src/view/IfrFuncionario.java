...
public class IfrFuncionario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jcbCargo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione o Cargo", "Piloto", "Co-piloto", "Comissário(a)", "Recepcionista", "Gerente" }));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        FuncionarioDao.popularTabela(tblFuncionario, nomePesquisa.getText(), cepPesquisa.getText(), "");
